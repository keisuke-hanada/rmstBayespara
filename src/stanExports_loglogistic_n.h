...
namespace model_loglogistic_n_namespace {
...
static constexpr std::array<const char*, 80> locations_array__ =
  ...
  " (in 'string', line 69, column 2 to column 57)",
  " (in 'string', line 70, column 2 to column 20)",
  " (in 'string', line 71, column 2 to column 36)",
  " (in 'string', line 37, column 2 to column 27)",
  " (in 'string', line 38, column 2 to column 52)",
  " (in 'string', line 39, column 2 to column 43)",
  " (in 'string', line 40, column 2 to line 41, column 41)",
  " (in 'string', line 72, column 2 to column 27)",
  " (in 'string', line 75, column 4 to column 34)",
  " (in 'string', line 73, column 17 to line 76, column 3)",
  " (in 'string', line 73, column 2 to line 76, column 3)",
  " (in 'string', line 77, column 2 to column 13)",
  " (in 'string', line 83, column 6 to column 63)",
  " (in 'string', line 82, column 29 to line 84, column 5)",
  " (in 'string', line 82, column 11 to line 84, column 5)",
  ...
  " (in 'string', line 78, column 17 to line 85, column 3)",
  ...
  " (in 'string', line 51, column 6 to column 36)",
  " (in 'string', line 49, column 19 to line 52, column 5)",
  " (in 'string', line 49, column 4 to line 52, column 5)",
  " (in 'string', line 53, column 4 to column 17)",
  " (in 'string', line 59, column 8 to column 62)",
  " (in 'string', line 58, column 31 to line 60, column 7)",
  " (in 'string', line 58, column 13 to line 60, column 7)",
  " (in 'string', line 57, column 8 to column 56)",
  " (in 'string', line 56, column 24 to line 58, column 7)",
  " (in 'string', line 56, column 6 to line 60, column 7)",
  " (in 'string', line 54, column 19 to line 61, column 5)",
  " (in 'string', line 54, column 4 to line 61, column 5)",
  " (in 'string', line 45, column 19 to line 62, column 3)",
  " (in 'string', line 45, column 2 to line 62, column 3)",
  " (in 'string', line 64, column 2 to column 19)",
  " (in 'string', line 65, column 2 to column 36)",
  ...
  " (in 'string', line 32, column 8 to column 11)",
  " (in 'string', line 32, column 20 to column 23)",
...
class model_loglogistic_n final : public model_base_crtp<model_loglogistic_n> {
private:
  int N;
...
public:
  ~model_loglogistic_n() {}
  model_loglogistic_n(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_loglogistic_n_namespace::model_loglogistic_n";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = Kc + 1 + 1 + M_1 + (M_1 * N_1);
  }
  inline std::string model_name() const final {
    return "model_loglogistic_n";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_loglogistic_n_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      lprior = (lprior + (stan::math::student_t_lpdf<false>(sd_1, 3, 0, 2.5)
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_loglogistic_n_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
        ...
        if (stan::math::logical_eq(
          ...
          stan::model::assign(log_lik,
            stan::math::loglogistic_lpdf<false>(
              ...
              stan::model::rvalue(mu, "mu", stan::model::index_uni(n)), shape),
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"b", "Intercept", "shape", "sd_1",
                "z_1"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"v", "lprior"};
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((Kc + 1) + 1) + M_1) + (M_1 * N_1));
    const size_t num_transformed = emit_transformed_parameters * ((N_1 + 1));
...
using stan_model = model_loglogistic_n_namespace::model_loglogistic_n;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_loglogistic_n_namespace::profiles__;
}
#endif
#endif
