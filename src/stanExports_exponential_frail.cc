...
#include "stanExports_exponential_frail.h"

RCPP_MODULE(stan_fit4exponential_frail_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_exponential_frail")
