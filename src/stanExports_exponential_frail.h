...
namespace model_exponential_frail_namespace {
...
static constexpr std::array<const char*, 79> locations_array__ =
  ...
  " (in 'string', line 35, column 2 to column 52)",
  " (in 'string', line 68, column 2 to column 27)",
  " (in 'string', line 69, column 2 to column 15)",
  " (in 'string', line 72, column 4 to column 29)",
  " (in 'string', line 70, column 17 to line 73, column 3)",
  " (in 'string', line 70, column 2 to line 73, column 3)",
  " (in 'string', line 81, column 6 to column 55)",
  " (in 'string', line 80, column 30 to line 82, column 5)",
  " (in 'string', line 80, column 11 to line 82, column 5)",
  " (in 'string', line 79, column 6 to column 56)",
  " (in 'string', line 78, column 29 to line 80, column 5)",
  " (in 'string', line 78, column 11 to line 82, column 5)",
  " (in 'string', line 77, column 6 to column 55)",
  " (in 'string', line 76, column 22 to line 78, column 5)",
  " (in 'string', line 76, column 4 to line 82, column 5)",
  " (in 'string', line 74, column 17 to line 83, column 3)",
  ...
  " (in 'string', line 43, column 4 to column 29)",
  " (in 'string', line 44, column 4 to column 17)",
  " (in 'string', line 47, column 6 to column 31)",
  " (in 'string', line 45, column 19 to line 48, column 5)",
  " (in 'string', line 45, column 4 to line 48, column 5)",
  " (in 'string', line 56, column 8 to column 54)",
  " (in 'string', line 55, column 32 to line 57, column 7)",
  " (in 'string', line 55, column 13 to line 57, column 7)",
  " (in 'string', line 54, column 8 to column 55)",
  " (in 'string', line 53, column 31 to line 55, column 7)",
  " (in 'string', line 53, column 13 to line 57, column 7)",
  " (in 'string', line 52, column 8 to column 54)",
  " (in 'string', line 51, column 24 to line 53, column 7)",
  " (in 'string', line 51, column 6 to line 57, column 7)",
  " (in 'string', line 49, column 19 to line 58, column 5)",
  " (in 'string', line 49, column 4 to line 58, column 5)",
  " (in 'string', line 40, column 19 to line 59, column 3)",
  " (in 'string', line 40, column 2 to line 59, column 3)",
...
class model_exponential_frail final : public model_base_crtp<model_exponential_frail> {
private:
  int N;
...
public:
  ~model_exponential_frail() {}
  model_exponential_frail(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_exponential_frail_namespace::model_exponential_frail";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = Kc + 1 + M_1 + N_1;
  }
  inline std::string model_name() const final {
    return "model_exponential_frail";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_exponential_frail_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
          ...
          for (int n = 1; n <= N; ++n) {
            ...
            if (stan::math::logical_eq(
              ...
              if (stan::math::logical_eq(
                ...
                lp_accum__.add(stan::math::exponential_lccdf(
                                 stan::model::rvalue(Y, "Y",
                                   stan::model::index_uni(n)),
                                 stan::math::inv(
                                   stan::model::rvalue(mu, "mu",
                ...
                if (stan::math::logical_eq(
                  ...
                  lp_accum__.add(stan::math::exponential_lcdf(
                                   stan::model::rvalue(Y, "Y",
                                     stan::model::index_uni(n)),
                                   stan::math::inv(
                                     stan::model::rvalue(mu, "mu",
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_exponential_frail_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"b", "Intercept", "sd_1", "v"};
    if (emit_transformed_parameters__) {
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((Kc + 1) + M_1) + N_1);
...
using stan_model = model_exponential_frail_namespace::model_exponential_frail;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_exponential_frail_namespace::profiles__;
}
#endif
#endif
