...
#include "stanExports_loglogistic_n.h"

RCPP_MODULE(stan_fit4loglogistic_n_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_loglogistic_n")
